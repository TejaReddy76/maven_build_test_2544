...
a persistence unit "jenk1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jenk1\pom.xml":
...
artifacts ("jenk1-ejb.jar" and "jenk1-web.war") are already built. You can build
